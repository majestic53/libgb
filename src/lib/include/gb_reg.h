...
namespace GB_NS {
	...
	#define GB_REG_LYC_OPER 0x00
	#define GB_REG_NR_10 0xff10
	#define GB_REG_NR_10_OPER 0x80
	#define GB_REG_NR_11 0xff11
	#define GB_REG_NR_11_OPER 0xbf
	#define GB_REG_NR_12 0xff12
	#define GB_REG_NR_12_OPER 0xf3
	#define GB_REG_NR_13 0xff13
	#define GB_REG_NR_14 0xff14
	#define GB_REG_NR_14_OPER 0xbf
	#define GB_REG_NR_21 0xff16
	#define GB_REG_NR_21_OPER 0x3f
	#define GB_REG_NR_22 0xff17
	#define GB_REG_NR_22_OPER 0x00
	#define GB_REG_NR_23 0xff18
	#define GB_REG_NR_24 0xff19
	#define GB_REG_NR_24_OPER 0xbf
	#define GB_REG_NR_30 0xff1a
	#define GB_REG_NR_30_OPER 0x7f
	#define GB_REG_NR_31 0xff1b
	#define GB_REG_NR_31_OPER 0xff
	#define GB_REG_NR_32 0xff1c
	#define GB_REG_NR_32_OPER 0x9f
	#define GB_REG_NR_33 0xff1d
	#define GB_REG_NR_33_OPER 0xbf
	#define GB_REG_NR_34 0xff1e
	#define GB_REG_NR_41 0xff20
	#define GB_REG_NR_41_OPER 0xff
	#define GB_REG_NR_42 0xff21
	#define GB_REG_NR_42_OPER 0x00
	#define GB_REG_NR_43 0xff22
	#define GB_REG_NR_43_OPER 0x00
	#define GB_REG_NR_44 0xff23
	#define GB_REG_NR_44_OPER 0xbf
	#define GB_REG_NR_50 0xff24
	#define GB_REG_NR_50_OPER 0x77
	#define GB_REG_NR_51 0xff25
	#define GB_REG_NR_51_OPER 0xf3
	#define GB_REG_NR_52 0xff26
	#define GB_REG_NR_52_OPER 0xf1
	#define GB_REG_OBP0 0xff48
	#define GB_REG_OBP0_OPER 0xff
	...
	#define GB_REG_TMA_OPER 0x00
	#define GB_REG_TAC 0xff07
	#define GB_REG_TAC_OPER 0x00
